...
const AboutPage = () => (
  <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#f6f3ff] via-[#fdfcff] to-[#e7e0fd] dark:from-[#1a1f2c] dark:via-gray-900 dark:to-black text-gray-800 dark:text-gray-100">
    {/* Hero */}
    <div className="relative flex flex-col items-center justify-center text-center py-36 px-4 md:px-0 overflow-hidden">
      <motion.h1
        initial={{ opacity: 0, scale: 0.93, y: 20 }}
        animate={{ opacity: 1, scale: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-600 bg-clip-text text-transparent drop-shadow-xl"
      >
        About Force
      </motion.h1>
      <motion.div
        ...
        className="max-w-2xl mx-auto text-lg md:text-xl text-balance"
      >
        <span className="inline-block relative bg-gradient-to-r from-white/60 via-purple-100/80 to-indigo-100/70 px-6 py-3 rounded-xl shadow-md border border-white/30 backdrop-blur-md mb-2">
    ...
    <Section className="py-16 md:py-24">
      <h2 className="text-4xl font-bold mb-6 text-gradient">Our Vision</h2>
      <p className="text-xl mb-3 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
    ...
    {/* What We're Solving */}
    <Section className="py-16 md:py-24">
      <h2 className="text-3xl font-bold mb-5">What We're Solving</h2>
      <motion.div
        initial={{ opacity: 0, x: 30 }}
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.7, delay: 0.11 }}
        className="prose prose-lg text-gray-600 dark:text-gray-300 bg-white/80 dark:bg-gray-900/60 px-7 md:px-10 py-6 rounded-2xl shadow-lg mx-auto max-w-3xl"
      >
        <p>
    ...
    {/* Our Approach */}
    <Section className="py-16 md:py-24">
      <h2 className="text-3xl font-bold mb-8 text-gradient">Our Approach</h2>
      <div className="grid gap-8 md:grid-cols-2">
        <motion.div
          whileHover={{ y: -6, scale: 1.03 }}
          className="p-7 rounded-2xl bg-gradient-to-br from-white/80 via-purple-50 to-indigo-100 dark:from-gray-900/80 dark:to-black/70 shadow-md border border-white/30 transition-all"
        >
          <h3 className="font-semibold mb-3 text-purple-700 dark:text-purple-300">Smart Multi-Modal Journaling</h3>
        ...
        <motion.div
          ...
          className="p-7 rounded-2xl bg-gradient-to-br from-white/80 via-purple-50 to-indigo-100 dark:from-gray-900/80 dark:to-black/70 shadow-md border border-white/30 transition-all"
        >
          <h3 className="font-semibold mb-3 text-indigo-600 dark:text-indigo-300">AI-Powered Analysis</h3>
          <ul className="list-disc pl-6 text-base text-gray-700 dark:text-gray-300 space-y-2">
        ...
        <motion.div
          whileHover={{ y: -6, scale: 1.03 }}
          className="p-7 rounded-2xl bg-gradient-to-br from-white/80 via-indigo-50 to-purple-100 dark:from-gray-900/80 dark:to-black/70 shadow-md border border-white/30 transition-all md:col-span-2"
        >
          <h3 className="font-semibold mb-3 text-pink-600 dark:text-pink-300">Generative UI & Personalization</h3>
          <ul className="list-disc pl-6 text-base text-gray-700 dark:text-gray-300 space-y-2">
    ...
    {/* The Force Ecosystem */}
    <Section className="py-16 md:py-24">
      <h2 className="text-3xl font-bold mb-8 text-gradient">The Force Ecosystem</h2>
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <motion.div whileHover={{ y: -7, scale: 1.05 }} className="p-6 flex flex-col items-center rounded-2xl bg-gradient-to-br from-purple-200/50 to-white dark:from-purple-900/50 dark:to-black/70 shadow-lg border border-white/30 min-h-[190px]">
        ...
        <motion.div whileHover={{ y: -7, scale: 1.05 }} className="p-6 flex flex-col items-center rounded-2xl bg-gradient-to-br from-pink-200/50 to-white dark:from-pink-900/40 dark:to-black/70 shadow-lg border border-white/30 min-h-[190px]">
        ...
        <motion.div whileHover={{ y: -7, scale: 1.05 }} className="p-6 flex flex-col items-center rounded-2xl bg-gradient-to-br from-blue-200/50 to-white dark:from-blue-900/40 dark:to-black/70 shadow-lg border border-white/30 min-h-[190px]">
        ...
        <motion.div whileHover={{ y: -7, scale: 1.05 }} className="p-6 flex flex-col items-center rounded-2xl bg-gradient-to-br from-green-200/50 to-white dark:from-green-900/40 dark:to-black/70 shadow-lg border border-white/30 min-h-[190px]">
    ...
    <Section className="py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <motion.div whileHover={{ scale: 1.05 }} className="rounded-2xl p-7 bg-white/70 dark:bg-gray-900/60 shadow-lg border border-gray-200/40 dark:border-gray-700/60 min-h-[185px]">
    ...
    <Section className="py-16 md:py-24">
      ...
      <motion.div
        ...
        className="prose prose-lg text-gray-700 dark:text-gray-300 bg-white/80 dark:bg-gray-900/60 px-7 md:px-10 py-6 rounded-2xl shadow-md mx-auto max-w-3xl"
      >
        <p>
    ...
    <Section className="py-10 md:py-16">
      <h3 className="text-xl font-semibold text-gradient mb-4 text-center">Let’s connect</h3>
      <SocialLinks />
