  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h3 className="flex items-center justify-center gap-2 text-2xl font-bold mb-5 text-gradient">
        ...
        <div className="pt-5 text-center text-base text-gray-500 dark:text-gray-400 animate-fade-in">
          Private beta launches <strong className="text-gradient">May 2025</strong>. Global rollout in Q3 2025.
        </div>
      </div>
    </form>
  );
