  ...
  return (
    <div className="relative overflow-hidden backdrop-blur-sm bg-white/30 dark:bg-black/20 border border-purple-100 dark:border-purple-900/30 rounded-2xl p-10 md:p-12 shadow-2xl">
      <div className="relative z-10">
        <h3 className="text-3xl md:text-4xl font-bold mb-4 text-gradient animate-fade-in">
          {title}
        </h3>
        ...
        <div className="animate-fade-in">
          <Dialog>
            <DialogTrigger asChild>
              <button
                className="inline-flex items-center gap-2 px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg hover:shadow-xl transition-all hover:scale-105 hover:-translate-y-1"
